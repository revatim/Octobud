...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private DifficultyHelper df;
    private OptionsHelper of;
    private User user;
    ...
    private void initObjects() {
        ...
        df = new DifficultyHelper(activity);
        user = new User();
    ...
    private void postDataToSQLite() {
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            String emails = textInputEditTextEmail.getText().toString().trim();
            user.setEmail(textInputEditTextEmail.getText().toString().trim());
            user.setPassword(textInputEditTextPassword.getText().toString().trim());
            user.setProduct_id("");
            user.setChild_name("");
            databaseHelper.addUser(user);
            databaseHelper.addUser1(emails);
            of = new OptionsHelper(activity);
